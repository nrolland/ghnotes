...
let generateDocs() =
  ...
  let options = 
    "--reference:\"" + source + "/../Packages/FSharp.Formatting.1.0.7/lib/net40/FSharp.CodeFormat.dll\" " +
    "--reference:\"" + source + "/../Packages/FSharp.Formatting.1.0.7/lib/net40/FSharp.Markdown.dll\" " +
